...
- (BOOL) createTable
{
    if (1) {
        ...
        if ([dataBase open]) {
            ...
            NSString *sql3_1 = @"insert into message(id,user_id,messagecontent,messagefrom,messagedate,state) values (\"1\",\"1\",\"学习iOS——segue/n学习了大量关于页面跳转的问题学会了很多很多知识，如这个跳转那个跳转\",\"dhcc\",\"2014.2.22\",\"未完成\")";
            NSString *sql3_2 = @"insert into message(id,user_id,messagecontent,messagefrom,messagedate,state) values (\"2\",\"2\",\"学习iOS——ARC/n学习了大量关于ARC的问题学会了很多很多知识，如这个ARC那个ARC\",\"admin\",\"2014.2.23\",\"未完成\")";
            NSString *sql3_3 = @"insert into message(id,user_id,messagecontent,messagefrom,messagedate,state) values (\"3\",\"1\",\"学习iOS——oc学习/n学习了大量关于oc的问题学会了很多很多知识，如这个oc那个oc\",\"dhcc\",\"2014.2.24\",\"未完成\")";
