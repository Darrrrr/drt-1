...
#define Log(s, ...) NSLog( @"[%@ %@] %@",NSStringFromClass([self class]), NSStringFromSelector(_cmd),[NSString stringWithFormat:(s), ##__VA_ARGS__] )

#define BUNDLE(_URL) [Global fullBundlePath:[@"Calendar.bundle/Images" stringByAppendingPathComponent:_URL]]
